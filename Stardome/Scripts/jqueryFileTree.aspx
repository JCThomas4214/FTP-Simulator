...
<%
	...
	foreach (System.IO.FileInfo fi in di.GetFiles())
	{
        ...
        Response.Write("\t<li id=\"file\" class=\"file ext_" + ext + "\"><input type=\"checkbox\" onclick=\"checkB(this.id)\" id=\"" + dir + fi.Name + "\" rel=\"" + dir + fi.Name + "\"><a href=\"#\" rel=\"" + dir + fi.Name + "\">" + fi.Name + "</a></li>\n");

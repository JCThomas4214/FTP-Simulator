...
<%
    ...
    {
        Response.Write("\t<li class=\"directory collapsed\"><input class=\"FTCB\" type=\"checkbox\" name='" + di_child.Name + "' onclick=\"checkFolderPermissions(this.id)\" id=\"" + dir + di_child.Name +
